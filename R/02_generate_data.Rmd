...
generate_distribution <- function(prop_monitored, n_bats, distribution, seed = NULL, 
    ...
    if(distribution == "bottom")  pp <- spatstat.core::rpoint(n_bats, function(x,y) {100 * exp(-dir_pattern*y)}, win = circle)
    if(distribution == "top")     pp <- spatstat.core::rpoint(n_bats, function(x,y) {100 * exp(dir_pattern*y)}, win = circle)
