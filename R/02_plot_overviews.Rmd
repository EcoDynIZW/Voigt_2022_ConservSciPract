...
```{r plots-distributions-rotor, fig.width=20, fig.height=11}
gg_uni_r  <- plot_dist(df_uni,  title = "Uniform")
gg_ran_r  <- plot_dist(df_ran,  title = "Random")
gg_inn1_r <- plot_dist(df_inn1, title = "Inner (moderate)")
gg_inn3_r <- plot_dist(df_inn3, title = "Inner (high)")
gg_out1_r <- plot_dist(df_out1, title = "Outer (moderate)")
gg_out3_r <- plot_dist(df_out3, title = "Outer (high)")
gg_bot1_r <- plot_dist(df_bot1, title = "Bottom (moderate)")
gg_bot3_r <- plot_dist(df_bot3, title = "Bottom (high)")
gg_top1_r <- plot_dist(df_top1, title = "Top (moderate)")
gg_top3_r <- plot_dist(df_top3, title = "Top (high)")
...
```{r plots-distributions-monitoring, fig.width=20, fig.height=11}
gg_uni_m  <- plot_dist(df_uni,  color = "orange2", title = "Uniform")
gg_ran_m  <- plot_dist(df_ran,  color = "orange2", title = "Random")
gg_inn1_m <- plot_dist(df_inn1, color = "orange2", title = "Inner (moderate)")
gg_inn3_m <- plot_dist(df_inn3, color = "orange2", title = "Inner (high)")
gg_out1_m <- plot_dist(df_out1, color = "orange2", title = "Outer (moderate)")
gg_out3_m <- plot_dist(df_out3, color = "orange2", title = "Outer (high)")
gg_bot1_m <- plot_dist(df_bot1, color = "orange2", title = "Bottom (moderate)")
gg_bot3_m <- plot_dist(df_bot3, color = "orange2", title = "Bottom (high)")
gg_top1_m <- plot_dist(df_top1, color = "orange2", title = "Top (moderate)")
gg_top3_m <- plot_dist(df_top3, color = "orange2", title = "Top (high)")
...
```{r plots-distributions-fatalities, fig.width=20, fig.height=11}
...
gg_inn1_f <- plot_dist(df_inn1, color = "orange2", shape = 4, title = "Inner (moderate)")
gg_inn3_f <- plot_dist(df_inn3, color = "orange2", shape = 4, title = "Inner (high)")
gg_out1_f <- plot_dist(df_out1, color = "orange2", shape = 4, title = "Outer (moderate)")
gg_out3_f <- plot_dist(df_out3, color = "orange2", shape = 4, title = "Outer (high)")
gg_bot1_f <- plot_dist(df_bot1, color = "orange2", shape = 4, title = "Bottom (moderate)")
gg_bot3_f <- plot_dist(df_bot3, color = "orange2", shape = 4, title = "Bottom (high)")
gg_top1_f <- plot_dist(df_top1, color = "orange2", shape = 4, title = "Top (moderate)")
gg_top3_f <- plot_dist(df_top3, color = "orange2", shape = 4, title = "Top (high)")
...
```{r convert-pdf, include = FALSE}
## convert PDFs to PNGs
path <- here("plots", "distributions")
